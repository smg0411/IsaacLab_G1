...
from isaaclab_tasks.manager_based.locomotion.velocity.config.g1.rough_env_cfg import G1RoughEnvCfg_PLAY,MY_G1RoughEnvCfg_PLAY
...
def main():
    ...
    camera_sensor_scene = demo_g1.env.unwrapped.scene["camera_sensor"]
